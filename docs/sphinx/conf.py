...
try:
    ...
    __version__ = get_package_version(__file__, "sdss-yao") or "dev"
...
.. |yao_version| replace:: {__version__}
"""
...
html_theme = "furo"
html_title = "yao's documentation"
...
htmlhelp_basename = "{0}pdoc".format("yao")
...
man_pages = [(master_doc, "yao", "{0} Documentation".format(project), [author], 1)]
